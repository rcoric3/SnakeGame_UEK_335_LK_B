...
public class Snake {
    ...
    public Snake(Bitmap bm, int x, int y, int length) {
        ...
        bm_body_bottom_right = Bitmap.createBitmap(bm, GameView.sizeOfMap, 0, GameView.sizeOfMap,
                GameView.sizeOfMap);
        bm_body_horizontal = Bitmap.createBitmap(bm, 2 * GameView.sizeOfMap, 0, GameView.sizeOfMap,
                GameView.sizeOfMap);
        bm_body_top_left = Bitmap.createBitmap(bm, 3 * GameView.sizeOfMap, 0, GameView.sizeOfMap,
                GameView.sizeOfMap);
        bm_body_top_right = Bitmap.createBitmap(bm, 4 * GameView.sizeOfMap, 0, GameView.sizeOfMap,
                GameView.sizeOfMap);
        bm_body_vertical = Bitmap.createBitmap(bm, 5 * GameView.sizeOfMap, 0, GameView.sizeOfMap,
                GameView.sizeOfMap);
        bm_head_down = Bitmap.createBitmap(bm, 6 * GameView.sizeOfMap, 0, GameView.sizeOfMap,
                GameView.sizeOfMap);
        bm_head_left = Bitmap.createBitmap(bm, 7 * GameView.sizeOfMap, 0, GameView.sizeOfMap,
                GameView.sizeOfMap);
        bm_head_right = Bitmap.createBitmap(bm, 8 * GameView.sizeOfMap, 0, GameView.sizeOfMap,
                GameView.sizeOfMap);
        bm_head_up = Bitmap.createBitmap(bm, 9 * GameView.sizeOfMap, 0, GameView.sizeOfMap,
                GameView.sizeOfMap);
        bm_tail_up = Bitmap.createBitmap(bm, 10 * GameView.sizeOfMap, 0, GameView.sizeOfMap,
                GameView.sizeOfMap);
        bm_tail_right = Bitmap.createBitmap(bm, 11 * GameView.sizeOfMap, 0, GameView.sizeOfMap,
                GameView.sizeOfMap);
        bm_tail_left = Bitmap.createBitmap(bm, 12 * GameView.sizeOfMap, 0, GameView.sizeOfMap,
                GameView.sizeOfMap);
        bm_tail_down = Bitmap.createBitmap(bm, 13 * GameView.sizeOfMap, 0, GameView.sizeOfMap,
                GameView.sizeOfMap);

        arrSnakeParts.add(new PartSnake(bm_head_right, x, y));
        for (int i = 1; i < length - 1; i++) {
            arrSnakeParts.add(new PartSnake(bm_body_horizontal, arrSnakeParts.get(i - 1).getX()
                    - GameView.sizeOfMap, y));
            setMove_right(true);
        }
        arrSnakeParts.add(new PartSnake(bm_tail_right, arrSnakeParts.get(length - 2).getX()
                - GameView.sizeOfMap, y));
    }
    ...
    public void update() {
        ...
        if (move_left) {
            arrSnakeParts.get(0).setX(arrSnakeParts.get(0).getX() - GameView.sizeOfMap);
            arrSnakeParts.get(0).setBm(bm_head_left);
        } else if (move_right) {
            arrSnakeParts.get(0).setX(arrSnakeParts.get(0).getX() + GameView.sizeOfMap);
            arrSnakeParts.get(0).setBm(bm_head_right);
        } else if (move_top) {
            arrSnakeParts.get(0).setY(arrSnakeParts.get(0).getY() - GameView.sizeOfMap);
            arrSnakeParts.get(0).setBm(bm_head_up);
        } else if (move_bottom) {
            arrSnakeParts.get(0).setY(arrSnakeParts.get(0).getY() + GameView.sizeOfMap);
            arrSnakeParts.get(0).setBm(bm_head_down);
        }
        for (int i = 1; i < length - 1; i++) {
            if (arrSnakeParts.get(i).getrLeft().intersect(arrSnakeParts.get(i + 1).getrBody())
                    && arrSnakeParts.get(i).getrBottom().intersect(arrSnakeParts.get(i - 1).getrBody())
                    || arrSnakeParts.get(i).getrLeft().intersect(arrSnakeParts.get(i - 1).getrBody())
                    && arrSnakeParts.get(i).getrBottom().intersect(arrSnakeParts.get(i + 1).getrBody())) {
                arrSnakeParts.get(i).setBm(bm_body_bottom_left);
            } else if (arrSnakeParts.get(i).getrRight().intersect(arrSnakeParts.get(i + 1).getrBody())
                    && arrSnakeParts.get(i).getrBottom().intersect(arrSnakeParts.get(i - 1).getrBody())
                    || arrSnakeParts.get(i).getrRight().intersect(arrSnakeParts.get(i - 1).getrBody())
                    && arrSnakeParts.get(i).getrBottom().intersect(arrSnakeParts.get(i + 1).getrBody())) {
                arrSnakeParts.get(i).setBm(bm_body_bottom_right);
            } else if (arrSnakeParts.get(i).getrLeft().intersect(arrSnakeParts.get(i + 1).getrBody())
                    && arrSnakeParts.get(i).getrTop().intersect(arrSnakeParts.get(i - 1).getrBody())
                    || arrSnakeParts.get(i).getrLeft().intersect(arrSnakeParts.get(i - 1).getrBody())
                    && arrSnakeParts.get(i).getrTop().intersect(arrSnakeParts.get(i + 1).getrBody())) {
                arrSnakeParts.get(i).setBm(bm_body_top_left);
            } else if (arrSnakeParts.get(i).getrRight().intersect(arrSnakeParts.get(i + 1).getrBody())
                    && arrSnakeParts.get(i).getrTop().intersect(arrSnakeParts.get(i - 1).getrBody())
                    || arrSnakeParts.get(i).getrRight().intersect(arrSnakeParts.get(i - 1).getrBody())
                    && arrSnakeParts.get(i).getrTop().intersect(arrSnakeParts.get(i + 1).getrBody())) {
                arrSnakeParts.get(i).setBm(bm_body_top_right);
            } else if (arrSnakeParts.get(i).getrTop().intersect(arrSnakeParts.get(i + 1).getrBody())
                    && arrSnakeParts.get(i).getrBottom().intersect(arrSnakeParts.get(i - 1).getrBody())
                    || arrSnakeParts.get(i).getrTop().intersect(arrSnakeParts.get(i - 1).getrBody())
                    && arrSnakeParts.get(i).getrBottom().intersect(arrSnakeParts.get(i + 1).getrBody())) {
                arrSnakeParts.get(i).setBm(bm_body_vertical);
            } else if (arrSnakeParts.get(i).getrLeft().intersect(arrSnakeParts.get(i + 1).getrBody())
                    && arrSnakeParts.get(i).getrRight().intersect(arrSnakeParts.get(i - 1).getrBody())
                    || arrSnakeParts.get(i).getrLeft().intersect(arrSnakeParts.get(i - 1).getrBody())
                    && arrSnakeParts.get(i).getrRight().intersect(arrSnakeParts.get(i + 1).getrBody())) {
                arrSnakeParts.get(i).setBm(bm_body_horizontal);
            }
            ;
        }
        if (arrSnakeParts.get(length - 1).getrRight().intersect(arrSnakeParts.get(length - 2).getrBody())) {
    ...
    public void draw(Canvas canvas) {
        for (int i = 0; i < length; i++) {
            canvas.drawBitmap(arrSnakeParts.get(i).getBm(), arrSnakeParts.get(i).getX(),
                    arrSnakeParts.get(i).getY(), null);
        }
    }
    ...
    public ArrayList<PartSnake> getArrSnakeParts() {
        return arrSnakeParts;
    }

    public void setArrSnakeParts(ArrayList<PartSnake> arrSnakeParts) {
        this.arrSnakeParts = arrSnakeParts;
    }
